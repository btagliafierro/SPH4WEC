...
# ${measuretool} -dirin ${diroutdata} -pointsdef:ptls[x=-0:0.50:10,y=0:0:1,z=-0.50:0.001:2000]  -onlytype:-all,+fluid -elevation -savecsv ${dirout2}/ #-savevtk ${dirout2}/wg1
...
cp ${dirout}/moordynplus_data/*.csv ${dirDataOutput}/
